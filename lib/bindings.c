/*
  Generated by ocaml-tree-sitter for requirements.
*/
...
// OCaml function
CAMLprim value octs_create_parser_requirements(value unit) {
  CAMLparam0();
  CAMLlocal1(v);
  ...
  ts_parser_set_language(parser, tree_sitter_requirements());
  CAMLreturn(v);
};
